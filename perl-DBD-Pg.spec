...
Version  : 3.12.3
Release  : 22
URL      : https://cpan.metacpan.org/authors/id/T/TU/TURNSTEP/DBD-Pg-3.12.3.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/T/TU/TURNSTEP/DBD-Pg-3.12.3.tar.gz
...
DESCRIPTION:
------------
This is version 3.12.3 of DBD::Pg, the Perl interface to Postgres using DBI.
...
%prep
%setup -q -n DBD-Pg-3.12.3
cd %{_builddir}/DBD-Pg-3.12.3
...
cp %{_builddir}/DBD-Pg-3.12.3/LICENSES/artistic.txt %{buildroot}/usr/share/package-licenses/perl-DBD-Pg/21bc5f3c797d4d5b72285198ffeb1e4e1f0a2902
if test -f Makefile.PL; then
