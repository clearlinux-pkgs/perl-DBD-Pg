...
cp %{_builddir}/DBD-Pg-3.10.0/LICENSES/artistic.txt %{buildroot}/usr/share/package-licenses/perl-DBD-Pg/21bc5f3c797d4d5b72285198ffeb1e4e1f0a2902
if test -f Makefile.PL; then
