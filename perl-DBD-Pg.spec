...
DESCRIPTION:
------------
This is version 3.15.0 of DBD::Pg, the Perl interface to Postgres using DBI.
...
%prep
%setup -q -n DBD-Pg-3.15.0
cd %{_builddir}/DBD-Pg-3.15.0
...
cp %{_builddir}/DBD-Pg-3.15.0/LICENSES/artistic.txt %{buildroot}/usr/share/package-licenses/perl-DBD-Pg/21bc5f3c797d4d5b72285198ffeb1e4e1f0a2902
cp %{_builddir}/DBD-Pg-3.15.0/LICENSES/artistic.txt %{buildroot}/usr/share/package-licenses/perl-DBD-Pg/21bc5f3c797d4d5b72285198ffeb1e4e1f0a2902
cp %{_builddir}/DBD-Pg-3.15.0/LICENSES/gpl-2.0.txt %{buildroot}/usr/share/package-licenses/perl-DBD-Pg/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
if test -f Makefile.PL; then
